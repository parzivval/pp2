...
while running:
    for event in pygame.event.get():
        ...
        screen.blit(font.render(f'Function: {shape}', True, BLACK), (10, 10))
        screen.blit(font.render(f'Width: {width}', True, BLACK), (300, 10))
        screen.blit(font.render(f'Color: {color}', True, BLACK), (380, 10))
